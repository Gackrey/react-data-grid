...
const StyledSorterTop = styled.span`
  font-size: 12px;
  display: inline-flex;
  align-items: center;
  color: inherit;
...
function Sorter({ sortDirection }: { sortDirection?: string }) {
  return (
    <StyledSorters aria-hidden="true">
      <StyledSorterTop role="img" aria-label="caret-up">
        <svg
          ...
          width="1em"
          height="1em"
          fill={`${sortDirection === 'ASC' ? '#182a88' : '#0000004a'}`}
          aria-hidden="true"
        >
          <path d="M858.9 689L530.5 308.2c-9.4-10.9-27.5-10.9-37 0L165.1 689c-12.2 14.2-1.2 35 18.5 35h656.8c19.7 0 30.7-20.8 18.5-35z" />
        </svg>
      </StyledSorterTop>
      <StyledSorterBottom role="img" aria-label="caret-down">
        <svg
          viewBox="0 0 1024 1024"
          focusable="false"
